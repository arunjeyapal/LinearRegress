 ...
 */
public class GradientDescent implements OptimizationAlg {
	 ...
	 */
	public GradientDescent(SimpleMatrix x, SimpleMatrix y, SimpleMatrix theta, double alpha, int iterations){
		this.X = x;
		this.y = y;
		this.theta = theta;
		this.alpha = alpha;
	 ...
	 * Computes the cost function every time the theta value gets updated
	...
	public SimpleMatrix computeJ_history(int curr_iter, SimpleMatrix the) {
		...
		//System.out.println("Iteration "+curr_iter+" | J val = "+J_hist[curr_iter][0]);
	...
	/**
	 * @return theta - returns a vector of theta values in SimpleMatrix format
	 * Compute theta using Gradient descent and returns the.
	 */
